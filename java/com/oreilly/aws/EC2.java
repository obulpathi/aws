 ...
 * service.
 */
public class EC2 extends AWS {
    
    public static URL ENDPOINT_URI;
    public static final String API_VERSION = "2007-08-29";
     ...
     */
    public EC2(boolean isDebugMode, boolean isSecureHttp) {
     ...
     * awsAccessKey, awsSecretKey, isDebugMode, and isSecureHttp.
     */
    public EC2(String awsAccessKey, String awsSecretKey, boolean isDebugMode,
    ...
    public Reservation runInstances(String imageId, String keypairName, 
        ...
        String instanceType, String addressingType) throws Exception 
    {
        Map<String, String> parameters = new HashMap<String, String>();
        ...
        parameters.put("AddressingType", addressingType);
